...
public class SettlementRepository(NpgsqlConnection connection)
{
    ...
    {
        return connection.QueryAsync<SettlementArrangementItem>(Sql.GetArrangement, param: new
        {
    ...
    {
        return connection.QueryAsync<SettlementMember>(Sql.GetMembers, param: new
        {
            SettlementId = settlementId
        });
    }
